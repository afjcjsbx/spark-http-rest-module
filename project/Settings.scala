...
object Settings {
  ...
  lazy val projectSettings = Seq(
    organization := "com.afjcjsbx",
    description := "HTTP Rest module for Spark"
  )
  ...
  lazy val buildSettings = Seq(
    ...
    console / scalacOptions --= Seq("-Ywarn-unused:imports", "-Xfatal-warnings"),
  ...
  lazy val commonSettings: Seq[Def.SettingsDefinition] =
    projectSettings ++ buildSettings ++ scalastyleSettings
